<?php 
 ...
 if(!isset($_SESSION['is_adminlogin'])){
  if(isset($_REQUEST['aEmail'])){
   ...
   $sql = "SELECT empEmail, password FROM technician_tb WHERE empEmail = '".$aEmail."' AND password = '".$aPassword."' limit 1";
...
<body>
 ...
 <p class="text-center" style="font-size:20px;"><i class="fas fa-user-secret text-danger"></i>Technician Area (Demo)</p>
