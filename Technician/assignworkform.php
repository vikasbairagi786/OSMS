...
$sql = "UPDATE assignwork_tb SET status='$status',time='$time',assign_date='$rdate',price='$price' WHERE request_id='$rid'";
...
<div class="col-sm-5 mt-5 jumbotron"> <!-- Start Assigned Work 3rd Column-->
 <form action="" method="POST">
   ...
   <div class="form-row">
	...
	<div class="form-group col-md-6">
      <label for="inputDate">Price</label>
      <input type="number" class="form-control" id="time" value=""name="price">
    </div>
	
	
   </div>
   
   <input type="hidden" name="status" value="Tech">
