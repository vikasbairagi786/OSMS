   ...
   if($_REQUEST['checkid'] == ""){
    ...
    <table class="table table-bordered">
     <tbody>
      ...
      <tr>
       ...
       <td><?php if(isset($row['Payment'])) {echo $row['Payment']; }  ?></td>
      </tr>
      <tr>
       <td>Customer Sign</td>
       <td></td>
    ...
    <div class="text-center">
     <form action="" class="mb-3 d-print-none">
	  ...
	  <a href="Paytm_standard_checkout-master/kart.php?number=<?php echo $row['price']; ?>"><input class="btn btn-secondary" type="payment" value="payment"></a>
     </form>
    </div>
    <?php } else {
