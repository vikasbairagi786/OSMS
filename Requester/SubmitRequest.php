...
if(isset($_REQUEST['submitrequest'])){
 ...
 if(($_REQUEST['requestinfo'] == "") || ($_REQUEST['requestdesc'] == "") || ($_REQUEST['requestername'] == "") || ($_REQUEST['requesteradd1'] == "") || ($_REQUEST['requesteradd2'] == "") || ($_REQUEST['requestercity'] == "") || ($_REQUEST['requesterstate'] == "") || ($_REQUEST['requesterzip'] == "") || ($_REQUEST['requesteremail'] == "") || ($_REQUEST['requestermobile'] == "") || ($_REQUEST['requestdate'] == "")){
  ...
  $time = $_REQUEST['time'];
  $sql = "INSERT INTO submitrequest_tb(request_info, request_desc, requester_name, requester_add1, requester_add2, requester_city, requester_state, requester_zip, requester_email, requester_mobile, request_date,time)VALUES('$rinfo', '$rdesc', '$rname', '$radd1', '$radd2', '$rcity', '$rstate', '$rzip', '$remail', '$rmobile', '$rdate','$time')";
  //echo $sql;die;
 ...
 <form class="mx-5" action="" method="POST">
  ...
  <div class="form-row">
   <div class="form-group col-md-6">
    ...
    <input type="email" class="form-control" id="inputEmail" value="<?php echo $_SESSION['rEmail'] ?>"name="requesteremail" readonly>
   </div>
   <div class="form-group col-md-2">
   ...
   <div class="form-group col-md-2">
    ...
    <input type="date" class="form-control" id="inputDate" name="requestdate" min="<?php echo date('Y-m-d'); ?>" >
   </div>
    <div class="form-group col-md-2">
    <label for="inputDate">Time</label>
    <input type="time" class="form-control" id="time" name="time" min="<?php echo date('Y-m-d'); ?>" >
   </div>
  </div>
