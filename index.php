...
<body>
 ...
 <header class="jumbotron back-image" style="background-image:url(images/Banner1.jpeg);">
  <div class="myclass mainHeading">
   ...
   <a href="#registration" class="btn btn-danger mr-4">Sign Up</a>   <br />
   <br />
   <br />
   <br />
   <p class="font-italic">Login For Technician</p>
   <a href="technician/login.php" class="btn btn-danger mr-4">Technician</a>
  </div>
     ...
     <div class="col-lg-3 col-sm-6"> <!-- Start 3rd Column -->
      <div class="card shadow-lg mb-2">
       <div class="card-body text-center">
        ...
        <p class="card-text">Fast and reliable</p>
       </div>
      </div>
     </div> <!-- End 3rd Column -->
